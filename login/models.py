...
class Team(models.Model):
    ...
    country = models.ForeignKey(Nation, on_delete=models.CASCADE, default=get_default_nation)
    ...
    def update_status(self, maxforeignplayer, minplayer, maxplayer):
        ...
        try:
            ...
            coach = None
        if foreign_players <= maxforeignplayer and total_players >= minplayer and total_players <= maxplayer and coach is not None:
...
class Fixture(models.Model):
    ...
    round_name = models.ForeignKey(Round, on_delete=models.CASCADE, related_name='roundname')
...
class Result(models.Model):
    ...
    goal_events = models.ManyToManyField(Player, through='GoalEvent', through_fields=('result', 'player'), related_name='goal_events')
...
class GoalEvent(models.Model):
    ...
    player = models.ForeignKey(Player, on_delete=models.CASCADE, related_name='scored_goal_events')
    assist_player = models.ForeignKey(Player, on_delete=models.CASCADE, related_name='assisted_goal_events')
    team = models.ForeignKey(Team, on_delete=models.CASCADE)
